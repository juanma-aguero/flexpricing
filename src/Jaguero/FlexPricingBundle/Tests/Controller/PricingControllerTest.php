...
namespace Jaguero\FlexPricingBundle\Tests\Controller;
...
class PricingControllerTest extends WebTestCase
{
    public function testCreate()
    {
        ...
        $form = $crawler->filter('form button[type="submit"]')->form(array(
            'pricing[title]' => 'Lorem ipsum dolor sit amet',
            'pricing[subtitle]' => 'Lorem ipsum dolor sit amet',
            'pricing[price]' => 'Lorem ipsum dolor sit amet',
            'pricing[important]' => true,
            'pricing[content]' => 'Lorem ipsum dolor sit amet',
            'pricing[action]' => 'Lorem ipsum dolor sit amet',
    ...
    {
        $client = static::createClient();
        $crawler = $client->request('GET', '/admin/pricing/new');
    ...
    public function testEdit()
    {
        ...
        $form = $crawler->filter('form button[type="submit"]')->form(array(
            'pricing[title]' => 'Changed',
            'pricing[subtitle]' => 'Changed',
            'pricing[price]' => 'Changed',
            'pricing[important]' => true,
            'pricing[content]' => 'Changed',
            'pricing[action]' => 'Changed',
            'pricing[enabled]' => true,
